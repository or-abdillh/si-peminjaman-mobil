                ...
                <section class="card-body d-flex justify-content-between align-items-center">
                    <section>
                        ...
                        <small class="text-secondary">
                            @if (@$signature)
                            Gunakan tombol disamping untuk melihatnya
                            @else
                    ...
                    @if (@$signature)
                    <button class="btn btn-info" data-bs-toggle="modal" data-bs-target="#showSignatureModal">
            ...
            <section class="card">
                <section class="card-body">
                    ...
                    <section class="w-full d-flex flex-column justify-center text-center">
                        <canvas id="canvas" width="500px" height="300px" class="mb-2" style="border-bottom: 1.5px solid whitesmoke; cursor: crosshair;"></canvas>
            ...
            <section class="card">
                <section class="card-body">
                    ...
                    <section class="row">
                        ...
                        @if (@$signature)
                        {{-- hapus tanda tangan --}}
                        <button class="btn btn-danger mb-2 col-12" data-bs-toggle="modal" data-bs-target="#deleteSignatureModal">Hapus</button>
                        @endif
                    </section>
                </section>
            </section>
...
<div class="modal fade" id="showSignatureModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <section class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tanda Tangan {{ auth()->user()->name }}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body d-flex justify-content-center">
                <img src="{{ asset('storage/signatures/' . $signature->image) }}" alt="">
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <a href="{{ asset('storage/signatures/' . $signature->image) }}" target="_blank" type="submit" class="btn btn-primary">Unduh</a>
            </div>
        </section>
    </div>
</div>
