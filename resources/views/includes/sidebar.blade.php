    ...
    <section class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                ...
                @if (auth()->user()->hasRole('manager'))
                    href="{{ route('manager.validation.index') }}"
                @elseif (auth()->user()->hasRole('admin'))
                    href="{{ route('admin.validation.index') }}"
                @else
                    href="{{ route('deputy.validation.index') }}"
                @endif
                >
                    {{-- icon --}}
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-file-signature {{ request()->routeIs('manager.validation.index') || request()->routeIs('deputy.validation.index') || request()->routeIs('admin.validation.index') ? '' : 'text-dark' }}"></i>
                    </div>
                    {{-- link title --}}
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('profile.index') ? 'active' : '' }}" href="{{ route('profile.index') }}">
                    {{-- icon --}}
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-user-gear {{ request()->routeIs('profile.index') ? '' : 'text-dark' }}"></i>
                    </div>
                    {{-- link title --}}
